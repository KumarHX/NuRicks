...
/***/ function(module, exports, __webpack_require__) {
	...
	// Custom Imports
	var main_component_1 = __webpack_require__(58);
	var main_component_2 = __webpack_require__(59);
	var backend_service_1 = __webpack_require__(60);
	var main_global_ts_1 = __webpack_require__(356);
	var appRoutes = [
	    { path: "", component: main_component_2.MainComponent }
	];
	var MainModule = (function () {
	    ...
	    MainModule = __decorate([
	        core_1.NgModule({
	            ...
	            declarations: [
	                main_component_1.OutletComponent,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Custom imports
	var backend_service_1 = __webpack_require__(60);
	var main_global_1 = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http_1 = __webpack_require__(57);
	// Custom imports
	var Rx_1 = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PersistentService = (function () {
	    function PersistentService(backendService) {
	        var _this = this;
	        this.backendService = backendService;
	        this.userObject = {
	            email: "",
	        ...
	        this.backendService.checkAuth()
	            ...
	            if (response.status == "1") {
	                ...
	                _this.userObject.stageName = a.stageName;
	                _this.userObject.firstName = a.firstName;
	                _this.userObject.lastName = a.lastName;
	                _this.userObject.soundcloudLink = a.soundcloudLink;
	                _this.userObject.bio = a.bio;
	                _this.userObject.instagramLink = a.instagramLink;
	                _this.userObject.youtubeLink = a.youtubeLink;
	                _this.userObject.facebookLink = a.facebookLink;
	                _this.userObject.picture_url = a.picture_url;
	                _this.userObject.verified = a.verified;
	            }
	        });
	    }
	    PersistentService = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof backend_service_1.BackendService !== 'undefined' && backend_service_1.BackendService) === 'function' && _a) || Object])
	    ], PersistentService);
