...
//removed border
     ...
     sendEmail: function(res, headliner, musicianName, eventDate, doorsOpen, ageRestriction, venueName, streetName, address, eventURL, guestName, numberInParty, transaction_id, email, eventName, musicianEmail){
